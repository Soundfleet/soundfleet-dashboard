...
interface AdEventFormProps {
  calendar: Calendar,
  adEvent?: AdEvent,
  enabled?: boolean,
  onSuccess?: (adEvent: AdEvent) => void,
  onDelete?: (adEvent: AdEvent) => void,
  onCancel?: () => void,
}


const AdEventForm: React.FC<AdEventFormProps> = (
  {
    calendar,
    adEvent,
    enabled,
  ...
  const formik = useFormik({
    initialValues: {
      start: adEvent?.start || null,
      end: adEvent?.end || null,
      schedule: adEvent?.schedule || null,
    },
  ...
  const handleSubmit = (
    ...
    if (adEvent) {
      apiClient.patch(
        `/calendars/${calendar.id}/ad-schedules/${adEvent.id}/`,
        {
          ...values,
